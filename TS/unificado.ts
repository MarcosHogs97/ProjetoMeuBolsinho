...
//Funcao para cadastras as despesas.
 function cadastrarDespesas() {
    ...
    let radioButtons: NodeListOf<HTMLInputElement> = document.querySelectorAll('input[name="unificado"]') as NodeListOf<HTMLInputElement>;
...
document.querySelectorAll('input[name="unificado"]').forEach((radio) => {
